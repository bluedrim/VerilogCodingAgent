...
- Treat the Current architecture/review implementation obligations, Mandatory RTL coding action plan, Reviewer fix checklist, and Review-to-code repair contract as implementation requirements while repairing the output.
- If reviewer repair guidance is provided, preserve and apply those required RTL fixes while repairing the output format.
- Do not drop architecture/control/datapath or review-driven RTL changes just to make the output parse.
